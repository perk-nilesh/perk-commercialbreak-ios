...
#   * Finally, don't worry about the indent, CocoaPods strips it!
  ...
  s.source_files  = "perk-commercialbreak-ios/*.h","*.m"
  s.preserve_paths = "perk-commercialbreak-ios/libCommercialBreakSDK.a"
  s.xcconfig = { 'LIBRARY_SEARCH_PATHS' => '$(SRCROOT)/Pods/perk-commercialbreak-ios/Lib' }

  s.ios.vendored_library = "perk-commercialbreak-ios/libCommercialBreakSDK.a"
  s.public_header_files = "perk-commercialbreak-ios/Header/*.h"
  s.xcconfig = { 'LD_RUNPATH_SEARCH_PATHS' => '@loader_path/../Frameworks'} 
  s.resources = "*.bundle"
   s.resource_bundles = {
     'CommercialBreakSDK' => ['perk-commercialbreak-ios/*.bundle']
   }
